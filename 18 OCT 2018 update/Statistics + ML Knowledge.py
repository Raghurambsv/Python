...
K-means clustering algorithm : https://www.datacamp.com/community/tutorials/k-means-clustering-python
                               it randomly picks the points and those points start collecting the points closer to it.
...
Decision Tree ====>  Decision tree classifier is a classification model which creates set of rules from the training dataset.(https://dataaspirant.com/2017/01/30/how-decision-tree-algorithm-works/)
                     Later the created rules used to predict the target class.
                     It uses concept like Information Gain or Gini Index to construct nodes.
                     ...
                     Information Gain: By calculating entropy measure of each attribute we can calculate their information gain.
                                       (entropy is measured b/w '0' and '1'....'0' means all values are same ...'1' means more values distinct )
                                       A branch with entropy 0 (more values same)    should be converted to a leaf node. A branch with entropy more than 0 needs further splitting.
                     ...
                     Advantage: Easy to understand....works well for less features and it being less frequently changing (HR policies)
                     
                     Disadvantage: There is a high probability of overfitting in Decision Tree.
                                 Generally, it gives low prediction accuracy for a dataset as compared to other machine learning algorithms.
                                Information gain in a decision tree with categorical variables gives a biased response for attributes with greater no. of categories.
                                Calculations can become complex when there are many class labels.
                                OverFitting=> Overfitting (Due to many outliers)is a practical problem while building a decision tree model. The model is having an issue of overfitting is considered when the algorithm continues to go deeper and deeper in the to reduce the training set error but results with an increased test set error i.e, Accuracy of prediction for our model goes down. It generally happens when it builds many branches due to outliers and irregularities in data.
                     Ex: As per class if someone likes one movie (looking at certain features of that movie)
                         you can predict that someone might also like a new genre of movie (based on learning from liked movie)
                     
                     
       
Random Forest ===> Random forest algorithm can use both for classification and the regression kind of problems(Mainly classification)(http://dataaspirant.com/2017/05/22/random-forest-algorithm-machine-learing/)
                   (Its closely related to DECISION TREE algo)
                   ...
                   In random forest algorithm, Instead of using information gain or gini index(As in Decision Tree algo) for calculating the root node, the process of finding the root node and splitting the feature nodes will happen randomly
                   ...
                   Disadvantage of Random Forest:
                       It needs very high GPU systems to deal with many random trees and find acceptable model
...
.metrics ==> Classification accuracy: percentage of correct predictions     
 ...
 F1 Score
###########           
 The F1 score can be interpreted as a weighted average of the precision and recall (or like Mean of precision n Recall)
 where an F1 score reaches its best value at 1 and worst score at 0           
            Confusion Matrix:
            #################
                  TrueGood(1)   TrueBad(0)
Predicted Good(1)    TP          FN
Predicted Bad (0)    FP          TN
...
https://www.analyticsvidhya.com/blog/2016/02/step-step-guide-building-sentiment-analysis-model-graphlab/ (use graph lab for giving confusion matrix)

Use K-Means CLUSTER for sentiment(FULL CODE) ==>http://nbviewer.jupyter.org/github/brandomr/document_cluster/blob/master/cluster_analysis_web.ipynb
...
1497  wget https://archive.ics.uci.edu/ml/machine-learning-databases/00360/AirQualityUCI.zip
 1501  wget https://archive.ics.uci.edu/ml/machine-learning-databases/00270/driftdataset.zip
 1
 


 
Additionally uci.edu has many data sets. We can encourage the participants to explore and play with these data sets. I also heard from the team they wanted to know where they can find large data sets. We should explore cloud providers like AWS who host public datasets. This will allow the team to get hands dirty on the big data side of things and allow them to prepare for the next week discussion where we will talk about deploying ML at scale
 
Here are some data sets that you can use and these are categorized by domain
...
Math Visualizations for Linear Algebra and Vector Algebra –
https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/featured
 
Probability and Statistics –
https://www.youtube.com/channel/UCRXuOXLW3LcQLWvxbZiIZ0w

GITHUB repository
==================
https://github.com/aarshayj/Analytics_Vidhya/tree/master/Articles
TIMESERIES blog==>https://www.analyticsvidhya.com/blog/2018/02/time-series-forecasting-methods/
Timeseries in pythion ==>https://www.analyticsvidhya.com/blog/2016/02/time-series-forecasting-codes-python/
Intent,sentiment plus extra API's at paralleldots website -https://www.paralleldots.com/text-analysis-apis