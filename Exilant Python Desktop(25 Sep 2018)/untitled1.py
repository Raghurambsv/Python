...
#################More efficient parameter tuning using GridSearchCV(It automatically tell that 13 is the best value)##############
#rather than you seeing it from earlier plotted graph of all values from K=1 to k=31
...
print(grid.best_estimator_) #It gives first best K=13 value eventhou 13,18 and 20 are best values as per graph
